...
@Controller
@ConditionalOnProperty(prefix = "adapquest.controller", name = "live")
@RequestMapping("/live")
public class LiveController {
	...
	@Autowired
	public LiveController(SurveyRepository surveys, SurveyController controller) {
	...
	public String start(
		...
		return "redirect:/live/survey/" + rd.token;
	}
	...
	public String survey(
		...
		if (resQuestion.getStatusCode() == HttpStatus.NO_CONTENT) {
			...
			return "redirect:/live/results/" + token;
		}
